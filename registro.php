                   ...
                   <div class="header_top_bottom_holder">
                    ...
                    <div class="header_menu_bottom">
                        <div class="header_menu_bottom_inner">
                            <div class="main_menu_header_inner_right_holder with_center_logo">
                                <nav class="main_menu drop_down animate_height">
                                    ...
                                    <li id="nav-menu-item-22057" class="menu-item menu-item-type-post_type menu-item-object-page  narrow" ><a href="index.php" class=" current "><i class="menu_icon fa blank"></i><span class="menu-text">Inicio</span><span class="plus"></span></a></li>
                                    ...
                                    <li id="nav-menu-item-22838" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-68 current_page_item active narrow"><a href="registro.php" class=""><i class="menu_icon fa blank"></i><span class="menu-text">Registrarse</span><span class="plus"></span></a></li>
                                    ...
                                    <li id="nav-menu-item-22095" class="menu-item menu-item-type-custom menu-item-object-custom  narrow"><a target="_blank" href="#" class=""><i class="menu_icon fa blank"></i><span class="menu-text">Ayuda</span><span class="plus"></span></a></li>                  
                                  </ul>        
                                </nav>
                        ...
                        <nav class="mobile_menu">
                            <ul id="menu-main-1" class=""><li id="mobile-menu-item-22057" class="menu-item menu-item-type-post_type menu-item-object-page "><a href="index.php" class=""><span>Inicio</span></a><span class="mobile_arrow"><i class="fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span></li>
                            ...
                            <li id="mobile-menu-item-22838" class="menu-item menu-item-type-post_type menu-item-object-page "><a href="registro.php" class=""><span>Registrarse</span></a><span class="mobile_arrow"><i class="fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span></li>
...
<div class="inner contact">
                ...
                <div class="contact-form">
                    <!-- Form -->
                    <form id="contact-us" method="post" action="registroTemp.php">
                        <!-- Left Inputs -->
                        <div class="col-xs-6 wow animated slideInLeft" data-wow-delay=".5s">
                            ...
                            <label>Nombre:</label>
                            <input type="text" pattern="[A-za-z\s]+" name="nombre" id="nombre" required="required" class="form" placeholder="No contiene numeros" />

                            <label>Apellidos:</label>
                            <input type="text" pattern="[A-za-z\s]+" name="apellido" id="apellido" required="required" class="form" placeholder="No contiene numeros">
                            <!-- Email -->
                            <label>Email:</label>
                            ...
                            <input type="text" pattern="[A-za-z\s]+" name="direccion" id="direccion" required="required" class="form" placeholder="Direccion">
