                   ...
                   <div class="header_top_bottom_holder">
                    ...
                    <div class="header_menu_bottom">
                        ...
                        <nav class="mobile_menu">
                            ...
                            <li id="mobile-menu-item-22104" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-68 current_page_item active"><a href="http://www.upi.ac.cr/contactenos/" class=" current "><span>Contáctenos</span></a><span class="mobile_arrow"><i class="fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span></li>
                        </ul>                      
                    </nav>
                   </div>
                </div>
